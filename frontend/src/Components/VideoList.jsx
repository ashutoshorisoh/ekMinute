...
const VideoList = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-6">
      {videos.length > 0 ? (
        videos.map((video) => (
          <div key={video._id} className="video-item bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-200 ease-in-out">
            ...
            <div className="p-4">
              ...
              <div className="mt-2 text-sm text-gray-500">
                ...
                <p>Owner: {video.owner[0]?.fullname || 'Unknown'}</p>
